...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="row mt-5 mb-3">
        ...
        <div class="col-sm-6">  
            ...
            <div class="row">
                <div class="col-sm-2 w-100 input-group mb-2 ">
                    <asp:Label runat="server" ID="lbReceiveLocation" Text="ปลายทาง" CssClass="input-group-text s-15px shadow" Visible="false"></asp:Label>
                    <asp:DropDownList runat="server" ID="ddlReceiveLocation" CssClass="btn dropdown-toggle s-15px shadow" Visible="false" DataValueField="val" DataTextField="text" OnSelectedIndexChanged="ddlReceiveLocation_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                </div>
            </div>
